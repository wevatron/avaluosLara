...
<h3>Catalogo de memorias ram</h3>
<div class="text-right" style="margin: 2%">
	<a href="{{ route('ram.create') }}" class="btn btn-primary">Agregar</a>
</div>
					...
					<td>
						...
						<div class="d-flex bd-highlight mb-3">
						  <div class="p-2 bd-highlight">
						  	<a href="{{ route('ram.edit',$marca->id) }}" >
						  		 <span class="badge badge-info">Editar</span>
						  	</a>
						  </div>
						  <div class="p-2 bd-highlight">
						  	{!! Form::open(['route'=>['ram.destroy', $marca->id],'method'=>'DELETE','id'=>'destroy' .$marca->id ]) !!}
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        <h5 class="modal-title" id="exampleModalLabel">¿Deseas eliminar {{ $marca->nombreRam }} permanentemente?</h5>
							      </div>
