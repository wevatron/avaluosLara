				...
				<tr>
					...
					<td >
						...
						<div class="d-flex bd-highlight mb-3">
						  ...
						  <div class="p-2 bd-highlight">
						  	{!! Form::open(['route'=>['marcas.destroy', $marca->id],'method'=>'DELETE','id'=>'destroy' .$marca->id ]) !!}
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							        <h5 class="modal-title" id="exampleModalLabel">¿Deseas eliminar {{ $marca->nombreMarca }} permanentemente?</h5>
							      </div>
