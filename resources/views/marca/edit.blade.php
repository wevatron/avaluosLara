...
<h3 style="margin-bottom:  2%">Editar la marca :  {{ $marca->nombreMarca }} </h3>
<div class="form-row">
	<div class="form-group col-sm-12 col-md-6 col-lg-6">
		<label  for="nombreMarca">Nombre de la marca</label>
		{!! Form::text('nombreMarca', null, ['class'=>'form-control', 'id' => 'nombreMarca', 'placeholder'=>'Escribe la marca ..']) !!}
	</div>
	<div class="form-group col-sm-12 col-md-6 col-lg-6">
